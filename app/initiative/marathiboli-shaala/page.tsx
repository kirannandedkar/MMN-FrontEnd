...
const NavData = [
  ...
  { title: "Norway Marathi Shaala", link: "#" },
];
      ...
      <MMNContainer className="gap-[40px] pb-[40px] lg:flex-row flex-col">
        <div className="min-h-screen flex flex-col bg-white">
          ...
          <p className="text-gray-700 mb-4">
            The purpose of the Norway Marathi Shala is to encourage
          ...
          <br />
          <p className="text-gray-700 mb-4">
            The Norway Marathi Shala is operated by Maharashtra Mandal
