...
const DescriptionItems = [
    ...
    { title: `Membership`, description: `MaharashtraMandalNorway is frivillig organisation registered in brønnøysundregisteret with org no 986 130 608. We dont sell any products. It is only possible to be members and membership per person is 160 NOK per month.` },
